...
const steps = [
  {
    ...
    description:
      "Enter your pickup and drop-off locations with our smart address detection",
  },
  {
    icon: Car,
    title: "Choose Your Ride",
    description:
      "Select from various vehicle types that suit your needs and budget",
  },
  {
    icon: CreditCard,
    title: "Pay Securely",
      ...
      <div className="mxw">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Getting your ride is as easy as 1-2-3. Follow these simple steps to
            book your journey.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => (
            <Card
              key={index}
              className="text-center border-0 shadow-lg bg-card hover:shadow-xl transition-all"
            >
